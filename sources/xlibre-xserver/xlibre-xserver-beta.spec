...
Source0:    https://github.com/X11Libre/%{reponame}/archive/refs/tags/xlibre-xserver-%{version}.tar.gz
...
Provides:       xlibre-xserver-beta = %{version}-%{release}
Requires:       libEGL
...
# its own sub-package:
Provides:       xlibre-xserver-beta-wrapper = %{version}-%{release}
...
Requires:       pkgconfig
Provides:       xlibre-xserver-beta-static
...
%prep
%setup -q -n %{reponame}-xlibre-xserver-%{version}
