...
- Update to 1.2.3.2
- Drop backported upstream FTBFS fix, fixed upstream in 1.2.3.2

* Thu Aug 14 2025 Kevin Kofler <Kevin@tigcc.ticalc.org> - 1.2.3.1-1
- Switch upstream to the X11Libre GitHub project
- Rename package from xorg-x11-drv-wacom to xlibre-xf86-input-wacom
- Do not use %%autosetup
- Backport upstream fix for FTBFS against the current xlibre-xserver
